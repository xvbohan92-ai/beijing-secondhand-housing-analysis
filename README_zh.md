...
- 3,000 条原始有效房源，覆盖 17 个位置类别，包括北京市全部 16 个行政区和北京周边
...
固定测试集的分价格区间结果显示，LightGBM 在总价 1,000 万元以下的房源中 MAE 明显更低；在 1,000 万元及以上的 106 条房源中，两种模型的 MAE 都约为 790 万元，说明高价房源是绝对预测误差的主要来源。
